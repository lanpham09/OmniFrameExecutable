...
static String DEVICE_NAME("2"); //device name/id, indices starting at 0, "0" = Arm 1
...
static double SENSOR_GAIN[7] = { (double)344 / 4095, -(double)500 / 4095, -(double)500 / 4095,
                                 (double)477 / 4095, 1.0, 1.0, 1.0
                               };

static double SENSOR_OFFSET[7] = {66, -642, -439, 119.9, 0, 0, 0};  //[deg, mm,mm,deg]
