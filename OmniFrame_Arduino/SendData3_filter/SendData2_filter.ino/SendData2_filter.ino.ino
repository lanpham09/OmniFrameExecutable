...
static String DEVICE_NAME("1"); //device name/id, indices starting at 0, "0" = Arm 1

//{Omni Rotation, Horizontal Linear, Vertical Linear, Center Rotation,TC,TC,TC}
//**********SENSOR SPECIFIC PROPERTIES*******************
static double SENSOR_GAIN[7] = { (double)344 / 4095, -(double)500 / 4095, -(double)500 / 4095,
                                 (double)470 / 4095, 1.0, 1.0, 1.0
                               };

static double SENSOR_OFFSET[7] = {61.8, -635, -509, 100.5, 0, 0, 0};  //[deg, mm,mm,deg]
double hor_offset = 242; 
double deflection_angle = 1.89; //Beam deflection along arm can cause large deflection angles
