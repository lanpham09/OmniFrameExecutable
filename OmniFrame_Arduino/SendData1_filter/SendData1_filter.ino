...
static String DEVICE_NAME("0"); //device name/id, indices starting at 0, "0" = Arm 1

//{Omni Rotation, Horizontal Linear, Vertical Linear, Center Rotation,TC,TC,TC}
//**********SENSOR SPECIFIC PROPERTIES*******************
static double SENSOR_GAIN[7] = { (double)341 / 4095, -(double)500 / 4095, -(double)500 / 4095,
                                 (double)476 / 4095, 1.0, 1.0, 1.0
                               };

static double SENSOR_OFFSET[7] = {48.7, -637.5, -516.8, 0, 0, 0, 0};  //[deg, mm,mm,deg]
double hor_offset = 242;                                              //[mm]
double deflection_angle = 2.15;                                       //[degrees]
//************************************************************************
