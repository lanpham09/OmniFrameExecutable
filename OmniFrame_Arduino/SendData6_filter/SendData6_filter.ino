...
static String DEVICE_NAME("5"); //device name/id, indices starting at 0, "0" = Arm 1

//{Omni Rotation, Horizontal Linear, Vertical Linear, Center Rotation,TC,TC,TC}
//**********SENSOR SPECIFIC PROPERTIES*******************
static double SENSOR_GAIN[7] = { (double)350 / 4095, -(double)500 / 4095, -(double)500 / 4095,
                                 (double)474 / 4095, 1.0, 1.0, 1.0
                               };

static double SENSOR_OFFSET[7] = {16.9, -611, -498, 0, 0, 0, 0};  //[deg, mm,mm,deg]
