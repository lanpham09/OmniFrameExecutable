...
static String DEVICE_NAME("0"); //device name/id
...
static double SENSOR_GAIN[7] = { (double)347/40950, -(double)500 / 40950, -(double)500/ 40950, 
                                        (double)476 / 40950, 1.0, 1.0, 1.0}; //{2.094, 166.66, 166.66, 2.094, 1, 1, 1};//6.14355897
static double SENSOR_OFFSET[7] = {83.5, -622, -520, 1.8, 0, 0, 0};
