...
static String DEVICE_NAME("3"); //device name/id, indices starting at 0, "0" = Arm 1
...
static double SENSOR_OFFSET[7] = {38.25, -637, -520, 136.7, 0, 0, 0};  //[deg, mm,mm,deg]
double hor_offset = 244;                                              //[mm]
double deflection_angle = 0;                                       //[degrees]
//************************************************************************
